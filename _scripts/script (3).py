...
# Create utils.py - Helper functions for formatting, file operations, etc.
...
def load_career_map(filepath: str = "career_map.json") -> Dict[str, Any]:
    """Load the career mapping database."""
    try:
        with open(filepath, "r") as f:
            return json.load(f)
    except FileNotFoundError:
        print(f"Error: {filepath} not found. Make sure career_map.json is in the project root.")
        return {}
...
print("✅ Created utils.py with 12+ utility functions")
