...
# Create a VS Code Codex guide with layered prompts

codex_guide = '''# VS Code Codex Integration Guide
...
with open('CODEX_GUIDE.md', 'w') as f:
    f.write(codex_guide)

print("✅ Created CODEX_GUIDE.md with 8 layers of development prompts")
